...
use PageObject\Homepage;
use PageObject\ArticleList;
use PageObject\Search;
...
class FeatureContext extends RawDrupalContext implements Context {
  ...
  public function __construct(Homepage $Homepage, Search $Search, ArticleList $ArticleList) {
